...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  for (const lotData of lotsData) {
    ...
    availableSpots = 0;
    if ("spots" in lotData) {
      for (spot of lotData["spots"]) {
        if (spot["status"] == "available") {
          availableSpots += 1;
        }
      }
    }
    capacity.innerText = `(${availableSpots}/${lotData["totalSpaces"]})`;
...
<div class="lot">
    <div class="lotText">
        <h2><a class="lotTitle" href="#">Example Lot</a>
        ...
        This is an example lot with example data
        <br><strong>(50/60) spots</strong>
    </div>
    <img class="lotImage" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTx9WXLGOA0VBQpzZwHhE76DnZnz7rcVYTmOeo7DH4Plg&amp;s" alt="examplelot">
</div>
    */
